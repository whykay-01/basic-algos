...
def findIndexRotatedArray(Array, element):
  # perform a binary search to find an actual starting index in the rotating array (aka smallest element and it's index)
  ...
  # need to find the reference point to use for the manipulations with the rotated array (if it is rotated)
  
  reference_point = start

  # perform binary search with accounts to what the reference pivot is
